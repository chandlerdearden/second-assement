...
function calcFinalPrice (carTotal, couponValue, tax) {
    return (carTotal * (tax + 1)) - couponValue
}
...
/*
    ...
    appitizers: because the customer will have a choice to order an appitizer
    totalPrice: To show how much the customer will owe
    }
*/
